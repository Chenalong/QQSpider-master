...
class InitMessages(object):
    ...
    def __init__(self):
        ...
        self.thread_num_Blog = 1  # 同时下载QQ的几篇日志
        self.thread_num_Mood = 1  # 同时下载QQ的几条说说
        self.blog_after_date = datetime.datetime.strptime("2010-01-01", "%Y-%m-%d")  # 爬这个时间之后的日志
        self.mood_after_date = datetime.datetime.strptime("2010-01-01", "%Y-%m-%d")  # 爬这个时间之后的说说
