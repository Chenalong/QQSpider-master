...
class SpideController(object):
    ...
    def store_dairy(self, qq):
        """ 获取空间信息，保存到本地 """
        logging.warning("enter store_dairy")
        try:
            ...
            logging.warning(text_information)
            ...
            if text_information:
                ...
                logging.warning("it is failed to spide " + qq)
        except Exception, e:
            logging.warn(e)
            self.my_messages.qq_fail_spided.append(qq)
